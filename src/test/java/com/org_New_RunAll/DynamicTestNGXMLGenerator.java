...
public class DynamicTestNGXMLGenerator {
	...
	public static void main(String[] args) {
		...
		String excelFilePath = "./PracticePage.xlsx";// Provide the path to your Excel file
	...
	private static void runTestNG() {
	 ...
	 private static void generateTestNGXML(List<String> testCasesToRun) throws IOException {
	        ...
	        for (String testCase : testCasesToRun) {
	            XmlClass xmlClass = new XmlClass("com.org_New_Test." + testCase); // Replace "your.package.name" with your actual package name
